...
class SearchCustomer:
    ...
    def searchCustomerByEmail(self, email):
        ...
        for rows in range(1, self.getNumberOfRows()+1):
            ...
            time.sleep(5)
            emailId = table.find_element(By.XPATH, "//*[@id='customers-grid']//tbody/tr["+str(rows)+"]/td[2]").text
            print(emailId)
            if emailId == email:
                passed = True
                break
    ...
    def searchCustomerByName(self, name):
        ...
        for rows in range(1, self.getNumberOfRows()+1):
            table = self.driver.find_element(By.XPATH, self.table_xpath)
            customerName = table.find_element(By.XPATH, "//*[@id='customers-grid']/tbody/tr["+str(rows)+"]/td[3]").text
